...
WHERE
    client_id = 'foo';
INSERT INTO oauth_client_details(`client_id`, `owner`, `access_token_validity`, `authorized_grant_types`, `autoapprove`, `client_name`, `client_secret`, `client_secret_raw`, `redirect_uri`, `refresh_token_validity`, `resources`, `scopes`) 
